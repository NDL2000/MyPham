...
<?php include "./connect.php";
  ...
  if(isset($_POST['sbm'])){
    ...
    $sql_product="INSERT INTO sanpham(MaSP,TenSP,DonGia,HinhAnh,MaDM,TrangThai,MoTa) VALUES ('$prd_id','$prd_name','$price_output','$image1','$category_id','$status1','$description')";
    $query_input_output=mysqli_query($conn,$sql_input_output);
    $query_product=mysqli_query($conn,$sql_product);
    move_uploaded_file($image_tmp,'./assets/images/'.$image1);
    header("Location: ./index.php?url=qlsanpham&kq=".$query_product);
  }
  }
?>
