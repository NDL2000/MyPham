                   ...
                   <div class="col large-9">
                        <div class="shop-container">
                            ...
                            <div class="products row row-small large-columns-3 medium-columns-3 small-columns-2 has-shadow row-box-shadow-2 row-box-shadow-3-hover">
                              ...
                              if(isset($_GET["dm"])){
                                $MaDM = $_GET["dm"];
                                $qr = "SELECT km.MaKM,km.TrangThai,sp.HinhAnh,sp.MaSP,sp.TenSP,sp.DonGia,ct.TyLeKM FROM sanpham as sp,ctkhuyenmai as ct,khuyenmai as km WHERE sp.MaSP=ct.MaSP and ct.MaKM=km.MaKM and km.TrangThai='Đang khuyến mãi' and MaDM='$MaDM'";
                        ...
                        ?>
                                ...
                                if(isset($_GET["dm"])){
                                    $MaDM = $_GET["dm"];
                                    $sql = "SELECT sp1.MaSP,sp1.TenSP,sp1.HinhAnh,sp1.DonGia FROM sanpham as sp1 WHERE not EXISTS (SELECT sp.MaSP FROM sanpham as sp,ctkhuyenmai as ct,khuyenmai as km WHERE sp.MaSP=ct.MaSP and ct.MaKM=km.MaKM and km.TrangThai='Đang khuyến mãi' and sp1.MaSP=sp.MaSP) and MaDM='$MaDM'";
                                    
                                }
                                else{
                                $sql = "SELECT sp1.MaSP,sp1.TenSP,sp1.HinhAnh,sp1.DonGia FROM sanpham as sp1 WHERE not EXISTS (SELECT sp.MaSP FROM sanpham as sp,ctkhuyenmai as ct,khuyenmai as km WHERE sp.MaSP=ct.MaSP and ct.MaKM=km.MaKM and km.TrangThai='Đang khuyến mãi' and sp1.MaSP=sp.MaSP)";
                                }
